    ...
    return(
        ...
        <div className='h-[700px] w-full flex flex-col justify-between items-center'>
            ...
            <div className='flex flex-col'>
                ...
                <button className='mt-5 mb-10 p-3 border-1 w-[400px] hover:bg-gray-400'>LOG-IN</button>
            ...
            <div className='flex flex-col h-[100px] justify-around items center'>
                <button className='p-2 border-1 w-[400px] hover:bg-gray-400'>CONTINUE WITH GOOGLE</button>
                <button className='p-2 border-1 w-[400px] hover:bg-gray-400'>CONTINUE WITH FACEBOOK</button>
            </div>
